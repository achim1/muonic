...
class RateWidget(QtGui.QWidget):
    ...
    def __init__(self,logger,parent = None):
        ...
        self.rates['edit_ch1'].setReadOnly(True)
        ...
        self.rates['edit_ch2'].setReadOnly(True)
...
#        self.data_file.close()
        ...
        valuelayout.addWidget(self.rates['label_ch1'],2,3)
        valuelayout.addWidget(self.rates['edit_ch1'],2,4)
        valuelayout.addWidget(self.rates['label_ch2'],3,3)
        valuelayout.addWidget(self.rates['edit_ch2'],3,4)
        valuelayout.addWidget(self.rates['label_ch3'],4,3)
        ...
        valuelayout.addWidget(self.general_info['label_daq_time'],12,3)
        valuelayout.addWidget(self.general_info['edit_daq_time'],12,4)
        valuelayout.addWidget(self.general_info['label_max_rate'],13,3)
        valuelayout.addWidget(self.general_info['edit_max_rate'],13,4)

        blinelayout.addWidget(ntb,14,0,1,3)
        blinelayout.addWidget(self.start_button,14,4)
        blinelayout.addWidget(self.stop_button,14,5)

        rate_widget.addWidget(valueBox,0,2)
        rate_widget.addWidget(plotBox,0,0,1,2)
        rate_widget.addWidget(buttomlineBox,1,0,1,3)
