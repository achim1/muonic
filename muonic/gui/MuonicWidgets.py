...
#        self.data_file.close()
        ...
        rate_widget.addWidget(self.scalars_monitor,0,0,12,2)
        rate_widget.addWidget(self.label_mean_rates,1,2)
        rate_widget.addWidget(self.rates['label_ch0'],1,3)
        rate_widget.addWidget(self.rates['edit_ch0'],1,4)
        rate_widget.addWidget(self.rates['label_ch1'],2,3)
        rate_widget.addWidget(self.rates['edit_ch1'],2,4)
        rate_widget.addWidget(self.rates['label_ch2'],3,3)
